...
from AlphaGo.go_data cimport _BLACK, _EMPTY, _STONE, _LIBERTY, _CAPTURE, _FREE, _PASS, _HASHVALUE, Group, Locations_List, locations_list_destroy, locations_list_new

# type of tensor created
# char works but float might be needed later
ctypedef float tensor_type
...
cdef class Preprocess:
    ...
    cdef dict  pattern_nakade_w
    cdef dict  pattern_response_12d_w
    cdef dict  pattern_non_response_3x3_w
