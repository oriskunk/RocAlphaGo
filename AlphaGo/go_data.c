...
static short *__pyx_f_7AlphaGo_7go_data_get_5x5_neighbors(char __pyx_v_size) {
  short *__pyx_v_neighbor5x5;
  short __pyx_v_location;
  char __pyx_v_x;
  char __pyx_v_y;
  short *__pyx_r;
  ...
  char __pyx_t_4;
  char __pyx_t_5;
  __Pyx_RefNannySetupContext("get_5x5_neighbors", 0);
 ...
 *         raise MemoryError()
 */
  __pyx_v_neighbor5x5 = ((short *)malloc((((__pyx_v_size * __pyx_v_size) * 24) * (sizeof(short)))));

  /* "AlphaGo/go_data.pyx":753
 *     # create array
 *     cdef short* neighbor5x5 = <short *>malloc( size * size * 24 * sizeof( short ) )
 *     if not neighbor5x5:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 * 
 */
  __pyx_t_1 = ((!(__pyx_v_neighbor5x5 != 0)) != 0);
  if (__pyx_t_1) {

    /* "AlphaGo/go_data.pyx":754
 *     cdef short* neighbor5x5 = <short *>malloc( size * size * 24 * sizeof( short ) )
 *     if not neighbor5x5:
 *         raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_location = ((__pyx_v_x + (__pyx_v_y * __pyx_v_size)) * 24);

      /* "AlphaGo/go_data.pyx":764
 * 
 *             location = ( x + ( y * size ) ) * 24
 *             neighbor5x5[ location +  0 ] = calculate_board_location_or_border( x - 2, y - 2, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location +  1 ] = calculate_board_location_or_border( x - 1, y - 2, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 0)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 2), (__pyx_v_y - 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":765
 *             location = ( x + ( y * size ) ) * 24
 *             neighbor5x5[ location +  0 ] = calculate_board_location_or_border( x - 2, y - 2, size )
 *             neighbor5x5[ location +  1 ] = calculate_board_location_or_border( x - 1, y - 2, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location +  2 ] = calculate_board_location_or_border( x    , y - 2, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 1)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 1), (__pyx_v_y - 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":766
 *             neighbor5x5[ location +  0 ] = calculate_board_location_or_border( x - 2, y - 2, size )
 *             neighbor5x5[ location +  1 ] = calculate_board_location_or_border( x - 1, y - 2, size )
 *             neighbor5x5[ location +  2 ] = calculate_board_location_or_border( x    , y - 2, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location +  3 ] = calculate_board_location_or_border( x + 1, y - 2, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 2)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border(__pyx_v_x, (__pyx_v_y - 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":767
 *             neighbor5x5[ location +  1 ] = calculate_board_location_or_border( x - 1, y - 2, size )
 *             neighbor5x5[ location +  2 ] = calculate_board_location_or_border( x    , y - 2, size )
 *             neighbor5x5[ location +  3 ] = calculate_board_location_or_border( x + 1, y - 2, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location +  4 ] = calculate_board_location_or_border( x + 2, y - 2, size )
 * 
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 3)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 1), (__pyx_v_y - 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":768
 *             neighbor5x5[ location +  2 ] = calculate_board_location_or_border( x    , y - 2, size )
 *             neighbor5x5[ location +  3 ] = calculate_board_location_or_border( x + 1, y - 2, size )
 *             neighbor5x5[ location +  4 ] = calculate_board_location_or_border( x + 2, y - 2, size )             # <<<<<<<<<<<<<<
 * 
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 4)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 2), (__pyx_v_y - 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":770
 *             neighbor5x5[ location +  4 ] = calculate_board_location_or_border( x + 2, y - 2, size )
 * 
 *             neighbor5x5[ location +  5 ] = calculate_board_location_or_border( x - 2, y - 1, size )             # <<<<<<<<<<<<<<
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 5)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 2), (__pyx_v_y - 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":771
 * 
 *             neighbor5x5[ location +  5 ] = calculate_board_location_or_border( x - 2, y - 1, size )
 *             neighbor5x5[ location +  6 ] = calculate_board_location_or_border( x - 1, y - 1, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location +  7 ] = calculate_board_location_or_border( x    , y - 1, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 6)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 1), (__pyx_v_y - 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":772
 *             neighbor5x5[ location +  5 ] = calculate_board_location_or_border( x - 2, y - 1, size )
 *             neighbor5x5[ location +  6 ] = calculate_board_location_or_border( x - 1, y - 1, size )
 *             neighbor5x5[ location +  7 ] = calculate_board_location_or_border( x    , y - 1, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location +  8 ] = calculate_board_location_or_border( x + 1, y - 1, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 7)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border(__pyx_v_x, (__pyx_v_y - 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":773
 *             neighbor5x5[ location +  6 ] = calculate_board_location_or_border( x - 1, y - 1, size )
 *             neighbor5x5[ location +  7 ] = calculate_board_location_or_border( x    , y - 1, size )
 *             neighbor5x5[ location +  8 ] = calculate_board_location_or_border( x + 1, y - 1, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location +  9 ] = calculate_board_location_or_border( x + 2, y - 1, size )
 * 
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 8)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 1), (__pyx_v_y - 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":774
 *             neighbor5x5[ location +  7 ] = calculate_board_location_or_border( x    , y - 1, size )
 *             neighbor5x5[ location +  8 ] = calculate_board_location_or_border( x + 1, y - 1, size )
 *             neighbor5x5[ location +  9 ] = calculate_board_location_or_border( x + 2, y - 1, size )             # <<<<<<<<<<<<<<
 * 
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 9)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 2), (__pyx_v_y - 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":776
 *             neighbor5x5[ location +  9 ] = calculate_board_location_or_border( x + 2, y - 1, size )
 * 
 *             neighbor5x5[ location + 10 ] = calculate_board_location_or_border( x - 2, y    , size )             # <<<<<<<<<<<<<<
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 10)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 2), __pyx_v_y, __pyx_v_size);

      /* "AlphaGo/go_data.pyx":777
 * 
 *             neighbor5x5[ location + 10 ] = calculate_board_location_or_border( x - 2, y    , size )
 *             neighbor5x5[ location + 11 ] = calculate_board_location_or_border( x - 1, y    , size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 12 ] = calculate_board_location_or_border( x + 1, y    , size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 11)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 1), __pyx_v_y, __pyx_v_size);

      /* "AlphaGo/go_data.pyx":778
 *             neighbor5x5[ location + 10 ] = calculate_board_location_or_border( x - 2, y    , size )
 *             neighbor5x5[ location + 11 ] = calculate_board_location_or_border( x - 1, y    , size )
 *             neighbor5x5[ location + 12 ] = calculate_board_location_or_border( x + 1, y    , size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 13 ] = calculate_board_location_or_border( x + 2, y    , size )
 * 
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 12)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 1), __pyx_v_y, __pyx_v_size);

      /* "AlphaGo/go_data.pyx":779
 *             neighbor5x5[ location + 11 ] = calculate_board_location_or_border( x - 1, y    , size )
 *             neighbor5x5[ location + 12 ] = calculate_board_location_or_border( x + 1, y    , size )
 *             neighbor5x5[ location + 13 ] = calculate_board_location_or_border( x + 2, y    , size )             # <<<<<<<<<<<<<<
 * 
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 13)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 2), __pyx_v_y, __pyx_v_size);

      /* "AlphaGo/go_data.pyx":781
 *             neighbor5x5[ location + 13 ] = calculate_board_location_or_border( x + 2, y    , size )
 * 
 *             neighbor5x5[ location + 14 ] = calculate_board_location_or_border( x - 2, y + 1, size )             # <<<<<<<<<<<<<<
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 14)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 2), (__pyx_v_y + 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":782
 * 
 *             neighbor5x5[ location + 14 ] = calculate_board_location_or_border( x - 2, y + 1, size )
 *             neighbor5x5[ location + 15 ] = calculate_board_location_or_border( x - 1, y + 1, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 16 ] = calculate_board_location_or_border( x    , y + 1, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 15)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 1), (__pyx_v_y + 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":783
 *             neighbor5x5[ location + 14 ] = calculate_board_location_or_border( x - 2, y + 1, size )
 *             neighbor5x5[ location + 15 ] = calculate_board_location_or_border( x - 1, y + 1, size )
 *             neighbor5x5[ location + 16 ] = calculate_board_location_or_border( x    , y + 1, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 17 ] = calculate_board_location_or_border( x + 1, y + 1, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 16)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border(__pyx_v_x, (__pyx_v_y + 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":784
 *             neighbor5x5[ location + 15 ] = calculate_board_location_or_border( x - 1, y + 1, size )
 *             neighbor5x5[ location + 16 ] = calculate_board_location_or_border( x    , y + 1, size )
 *             neighbor5x5[ location + 17 ] = calculate_board_location_or_border( x + 1, y + 1, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 18 ] = calculate_board_location_or_border( x + 2, y + 1, size )
 * 
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 17)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 1), (__pyx_v_y + 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":785
 *             neighbor5x5[ location + 16 ] = calculate_board_location_or_border( x    , y + 1, size )
 *             neighbor5x5[ location + 17 ] = calculate_board_location_or_border( x + 1, y + 1, size )
 *             neighbor5x5[ location + 18 ] = calculate_board_location_or_border( x + 2, y + 1, size )             # <<<<<<<<<<<<<<
 * 
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 18)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 2), (__pyx_v_y + 1), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":787
 *             neighbor5x5[ location + 18 ] = calculate_board_location_or_border( x + 2, y + 1, size )
 * 
 *             neighbor5x5[ location + 19 ] = calculate_board_location_or_border( x - 2, y + 2, size )             # <<<<<<<<<<<<<<
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 19)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 2), (__pyx_v_y + 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":788
 * 
 *             neighbor5x5[ location + 19 ] = calculate_board_location_or_border( x - 2, y + 2, size )
 *             neighbor5x5[ location + 20 ] = calculate_board_location_or_border( x - 1, y + 2, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 21 ] = calculate_board_location_or_border( x    , y + 2, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 20)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x - 1), (__pyx_v_y + 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":789
 *             neighbor5x5[ location + 19 ] = calculate_board_location_or_border( x - 2, y + 2, size )
 *             neighbor5x5[ location + 20 ] = calculate_board_location_or_border( x - 1, y + 2, size )
 *             neighbor5x5[ location + 21 ] = calculate_board_location_or_border( x    , y + 2, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 22 ] = calculate_board_location_or_border( x + 1, y + 2, size )
 ...
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 21)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border(__pyx_v_x, (__pyx_v_y + 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":790
 *             neighbor5x5[ location + 20 ] = calculate_board_location_or_border( x - 1, y + 2, size )
 *             neighbor5x5[ location + 21 ] = calculate_board_location_or_border( x    , y + 2, size )
 *             neighbor5x5[ location + 22 ] = calculate_board_location_or_border( x + 1, y + 2, size )             # <<<<<<<<<<<<<<
 *             neighbor5x5[ location + 23 ] = calculate_board_location_or_border( x + 2, y + 2, size )
 * 
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 22)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 1), (__pyx_v_y + 2), __pyx_v_size);

      /* "AlphaGo/go_data.pyx":791
 *             neighbor5x5[ location + 21 ] = calculate_board_location_or_border( x    , y + 2, size )
 *             neighbor5x5[ location + 22 ] = calculate_board_location_or_border( x + 1, y + 2, size )
 *             neighbor5x5[ location + 23 ] = calculate_board_location_or_border( x + 2, y + 2, size )             # <<<<<<<<<<<<<<
 * 
 *     return neighbor5x5
 */
      (__pyx_v_neighbor5x5[(__pyx_v_location + 23)]) = __pyx_f_7AlphaGo_7go_data_calculate_board_location_or_border((__pyx_v_x + 2), (__pyx_v_y + 2), __pyx_v_size);
    }
  }

  /* "AlphaGo/go_data.pyx":793
 *             neighbor5x5[ location + 23 ] = calculate_board_location_or_border( x + 2, y + 2, size )
 * 
 *     return neighbor5x5             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("AlphaGo.go_data.get_5x5_neighbors", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
 ...
 */
    PyErr_NoMemory(); __PYX_ERR(0, 813, __pyx_L1_error)
 ...
 */
    __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_random); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_randint); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_iinfo); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_uint64); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 817, __pyx_L1_error)
    ...
    if (!__pyx_t_6) {
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 817, __pyx_L1_error)
      ...
      if (PyFunction_Check(__pyx_t_7)) {
        ...
        __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 817, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_7)) {
        PyObject *__pyx_temp[2] = {__pyx_t_6, __pyx_t_8};
        __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 817, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      } else
      #endif
      {
        __pyx_t_9 = PyTuple_New(1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 817, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_GIVEREF(__pyx_t_6); PyTuple_SET_ITEM(__pyx_t_9, 0, __pyx_t_6); __pyx_t_6 = NULL;
        __Pyx_GIVEREF(__pyx_t_8);
        PyTuple_SET_ITEM(__pyx_t_9, 0+1, __pyx_t_8);
        __pyx_t_8 = 0;
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_9, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 817, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_max); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __pyx_t_7 = 0;
    __pyx_t_7 = PyDict_New(); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    if (PyDict_SetItem(__pyx_t_7, __pyx_n_s_dtype, __pyx_n_s_uint64) < 0) __PYX_ERR(0, 817, __pyx_L1_error)
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_10 = __Pyx_PyInt_As_unsigned_PY_LONG_LONG(__pyx_t_9); if (unlikely((__pyx_t_10 == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 817, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    (__pyx_v_zobrist_lookup[__pyx_v_i]) = __pyx_t_10;
  }

  /* "AlphaGo/go_data.pyx":819
 *         zobrist_lookup[i] = np.random.randint(np.iinfo(np.uint64).max, dtype='uint64')
 * 
 *     return zobrist_lookup             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  if (__Pyx_ExportFunction("get_5x5_neighbors", (void (*)(void))__pyx_f_7AlphaGo_7go_data_get_5x5_neighbors, "short *(char)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 * 
 */
  __pyx_v_7AlphaGo_7go_data__HASHVALUE = 5;
