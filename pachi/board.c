...
board_setup(struct board *b)
{
	...
	b->last_move = b->last_move2 = b->last_move3 = b->last_move4 = b->last_move5 = b->last_move6 = b->last_move7 = b-> last_move8 = b->last_ko = b->ko = m;
}
...
board_play_outside(struct board *board, struct move *m, int f, struct board_undo *u)
{
	...
	if (!u) {
		...
		board->last_move8 = board->last_move7;
		board->last_move7 = board->last_move6;
		board->last_move6 = board->last_move5;
		board->last_move5 = board->last_move4;
...
int board_undo(struct board *board)
{
	...
	board->last_move4 = board->last_move5;
	board->last_move5 = board->last_move6;
	board->last_move6 = board->last_move7;
	board->last_move7 = board->last_move8;
