    ...
    for (j = 0; j < size; j++) {
        for(k = 0; k < size; k++) {
            ...
            if(c == b->last_move.coord)
                result[p] = 2*color_const;
            else if(c == b->last_move2.coord)
                result[p] = 3*color_const;
            else if(c == b->last_move3.coord)
                result[p] = 4*color_const;
            else if(c == b->last_move4.coord)
                result[p] = 5*color_const;
            else if(c == b->last_move5.coord)
                result[p] = 6*color_const;
            else if(c == b->last_move6.coord)
                result[p] = 7*color_const;
            else if(c == b->last_move7.coord)
                result[p] = 8*color_const;
            else if(c == b->last_move8.coord)
                result[p] = 9*color_const;
            else
                result[p] = 1*color_const;
        }
    }
